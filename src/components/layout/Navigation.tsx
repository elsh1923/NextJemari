...
export function Navigation() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-200 bg-white/80 backdrop-blur-sm dark:border-[#1A1A1C] dark:bg-[#0A0A0C]/80">
          ...
          <div className="hidden flex-1 items-center justify-center px-4 lg:flex lg:px-8">
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2 pl-10 pr-4 text-sm placeholder-slate-400 transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-[#1A1A1C] dark:bg-[#111113] dark:text-slate-100 dark:placeholder-slate-500 dark:focus:border-blue-400"
              />
            </form>
          </div>
